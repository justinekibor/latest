    ...
    <div id="wrapper"> 
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="icon-grid"></i></a>
                <div class="top-left-part"><a class="logo" href="<?php echo base_url('admin/dashboard/') ?>"><b><img src="<?php echo base_url();?>leasehouse/small.png" height="60" alt="LeaseHouse" /></b><span class="hidden-xs">LeaseHouse</span></a></div>
                        ...
                        <ul class="dropdown-menu mailbox animated bounceInRight">
                            ...
                            <li>
                                <div class="message-center">
                                    ...
                                    <a href="<?php echo base_url();?>admin/notification/reply/<?php echo $note['complaint_id'];?>">
                                        ...
                                        <div class="mail-contnet">
                                            <h5><?php echo $note['fname'];?></h5> <span class="mail-desc"><?php echo $note['subject'];?></span> <span class="time"><?php echo $note['complaint_date'];?></span> </div>
                                    </a>
                                <?php endforeach?>
                                </div>
                            </li>
            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="<?php echo base_url('admin/dashboard') ?>" class="waves-effect"><i class="ti-dashboard p-r-10"></i> <span class="hide-menu">Dashboard</span></a> </li>
                                         <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-product-hunt"></i> <span class="hide-menu">Rent<span class="fa arrow"></span><span class="label label-rouded label-danger pull-right">1</span></span></a>
                        <ul class="nav nav-second-level">
                             <li> <a href="<?php echo base_url('admin/rent') ?>"><i class="fa fa-plus p-r-10"></i><span class="hide-menu">Collect Rent</span></a></li>
                      </ul>
                    </li>
                                        <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-product-hunt"></i> <span class="hide-menu">Plots <span class="fa arrow"></span><span class="label label-rouded label-danger pull-right">2</span></span></a>
                        <ul class="nav nav-second-level">
                             <li> <a href="<?php echo base_url('admin/Plot') ?>"><i class="fa fa-plus p-r-10"></i><span class="hide-menu">New Plot</span></a></li>
                        <li><a href="<?php echo base_url('admin/plot/all_plot_list') ?>"><i class="fa fa-list p-r-10"></i><span class="hide-menu">All Plots</span></a></li>
                      </ul>
                    </li>
                     ...
                     <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-product-hunt"></i> <span class="hide-menu">Rooms <span class="fa arrow"></span><span class="label label-rouded label-danger pull-right">2</span></span></a>
                        <ul class="nav nav-second-level">
                             <li> <a href="<?php echo base_url('admin/rooms') ?>"><i class="fa fa-plus p-r-10"></i><span class="hide-menu">New Room</span></a></li>
                        <li><a href="<?php echo base_url('admin/rooms/all_room_list') ?>"><i class="fa fa-list p-r-10"></i><span class="hide-menu">All Rooms</span></a></li>
                      </ul>
                    </li>
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-product-hunt"></i> <span class="hide-menu">Communication<span class="fa arrow"></span><span class="label label-rouded label-danger pull-right">3</span></span></a>
                        <ul class="nav nav-second-level">
                             <li> <a href="<?php echo base_url('admin/communication/email') ?>"><i class="fa fa-plus p-r-10"></i><span class="hide-menu">Email</span></a></li>
                             <li> <a href="<?php echo base_url('admin/communication/sms') ?>"><i class="fa fa-plus p-r-10"></i><span class="hide-menu">SMS</span></a></li>
        ...
        <div id="page-wrapper">
			...
			<div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">LeaseHouse Admin</h4>
                    </div>
