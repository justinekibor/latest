            ...
            <?php endif ?>
                     ...
                     <i class="fa fa-plus"></i> &nbsp; Add News<a href="<?php echo base_url('admin/rooms/all_room_list') ?>" class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i> List of news </a>
