    ...
    <div class="white-box">
               ...
               <div align="center">
				...
				<img  width="100" height="100" src="<?php echo base_url(); ?>leasehouse/logo.png">
                    <br><br>
					Welcome to<br> <strong style="color:green">LeaseHouse</strong>. Recover your password here
                <div align="center">
		...
		<br><br>
						<form class="form-horizontal form-material" id="loginform" action="<?php echo base_url('auth/changing/'.$key); ?>" method="post"> 
         <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="password" name="password" required="" placeholder="New password" style="width:100%" autocomplete="off">
                        </div>
                    </div>
       ...
       <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="password" name="cpassword" required="" placeholder="Confirm Password" style="width:100%" autocomplete="">
                        </div>
                    </div>
...
<button class="btn btn-info style1 btn-lg btn-block text-uppercase waves-effect waves-light" type="submit" style="width:100%; color:white">Change Password
</button>
