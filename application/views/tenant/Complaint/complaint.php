                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-3  col-sm-4 col-xs-12 inbox-panel">
                                    <div> <a href="<?php echo base_url()?>tenant/complaint" class="btn btn-custom btn-block waves-effect waves-light">Compose</a>
                                        <div class="list-group mail-list m-t-20"> <a href="<?php echo base_url()?>tenant/complaint/complaints" class="list-group-item active">Inbox <span class="label label-rouded label-success pull-right"></span></a></a> </div>
                                        <hr class="m-t-5">
