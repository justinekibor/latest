            ...
            <?php endif ?>
                           ...
                           if($user['deposit']>0){
                                ...
                                <tr>
                                    ...
                                    <?php if($user['deposit']<5000){?>
                                    <td class="" style="color: darkblue;"><?php echo $user['deposit'];?></td>

                                   <?php }else if($user['deposit']>5000){?>
                                    <td class="" style="color: red;"><?php echo $user['deposit'];?></td>
                                    <?php }?>
